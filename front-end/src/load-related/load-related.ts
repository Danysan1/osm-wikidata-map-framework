...
const rawJsonProps = process.argv[3] || process.env.NEXT_PUBLIC_OWMF_osm_wikidata_properties,
...
const wikidata_country = process.env.NEXT_PUBLIC_OWMF_wikidata_country || undefined;
