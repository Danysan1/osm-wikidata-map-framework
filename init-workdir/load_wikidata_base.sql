...
PREPARE load_wikidata_base_data (JSON) AS
UPDATE wikidata
...
PREPARE load_wikidata_base_picture (JSON) AS
...
EXECUTE load_wikidata_base_new_cods ('__WIKIDATA_JSON__'::JSON);
EXECUTE load_wikidata_base_data ('__WIKIDATA_JSON__'::JSON);
EXECUTE load_wikidata_base_picture ('__WIKIDATA_JSON__'::JSON);
