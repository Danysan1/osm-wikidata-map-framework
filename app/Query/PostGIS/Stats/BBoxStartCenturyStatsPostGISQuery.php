...
class BBoxStartCenturyStatsPostGISQuery extends BBoxStatsPostGISQuery
{
        ...
        return
            ...
            FROM (
                SELECT
                    ...
                    --EXTRACT(CENTURY FROM COALESCE(wd_start_date, wd_birth_date, wd_event_date)) AS century_name,
                    EXTRACT(CENTURY FROM COALESCE(wd_start_date, wd_birth_date, wd_event_date)) AS century
                ...
                AND COALESCE(wd_start_date, wd_birth_date, wd_event_date) IS NOT NULL
                $filterClause
                GROUP BY century
