...
function loadWikidataPartsOfEntities(PDO $dbh, string $wikidataEndpointURL, string $fromOsmColumns): int
{
    return loadWikidataRelatedEntities(
        ...
        "et_el_id, et_wd_id, et_from_el_id, $fromOsmColumns, et_from_osm_wikidata_wd_id, et_from_osm_wikidata_prop_cod, et_recursion_depth, et_from_parts_of_wd_id",
        "et_el_id, w2.wd_id, et_from_el_id, $fromOsmColumns, et_from_osm_wikidata_wd_id, et_from_osm_wikidata_prop_cod, et_recursion_depth, w1.wd_id",
