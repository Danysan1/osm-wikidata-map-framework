REM This script is used to fix the permissions of the Docker socket so that Airflow DockerOperators can access it.
REM It is supposed to be run from the Docker host
REM See https://stackoverflow.com/a/69103823
