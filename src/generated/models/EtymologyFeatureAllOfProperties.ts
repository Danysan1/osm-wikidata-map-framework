 ...
 * 
 * @export
 * @interface EtymologyFeatureAllOfProperties
 */
export interface EtymologyFeatureAllOfProperties {
    /**
     * 
     * @type {string}
     * @memberof EtymologyFeatureAllOfProperties
     */
    countryColor?: string;
    /**
     * 
...
/**
 * Check if a given object implements the EtymologyFeatureAllOfProperties interface.
 */
export function instanceOfEtymologyFeatureAllOfProperties(value: object): boolean {
    let isInstance = true;
...
export function EtymologyFeatureAllOfPropertiesFromJSON(json: any): EtymologyFeatureAllOfProperties {
    return EtymologyFeatureAllOfPropertiesFromJSONTyped(json, false);
}

export function EtymologyFeatureAllOfPropertiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EtymologyFeatureAllOfProperties {
...
export function EtymologyFeatureAllOfPropertiesToJSON(value?: EtymologyFeatureAllOfProperties | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
