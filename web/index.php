...
<body>
    ...
    <div id="intro">
        ...
        <p>
            ...
            <a href="https://gitlab.com/dsantini/open-etymology-map">Contribute</a> |
            <a href="https://www.dsantini.it">About me</a>
        </p>
    ...
    <template id="detail_template">
        <div class="detail_container">
            ...
            <a class="k-button w3-button w3-white w3-border w3-border w3-round-large osm_button" target="_blank"><img src="img/osm.svg" alt="OpenStreetMap logo">OpenStreetMap</a>
        ...
        <div class="etymology grid grid-auto">
            <div class="column">
                ...
                <div class="info column">
                    <a class="k-button w3-button w3-white w3-border w3-border w3-round-large wikidata_button" target="_blank"><img src="img/wikidata.svg" alt="Wikidata logo"> Wikidata</a>
                    <a class="k-button w3-button w3-white w3-border w3-border w3-round-large wikipedia_button" target="_blank"><img src="img/wikipedia.png" alt="Wikipedia logo"> Wikipedia</a>
                    <a class="k-button w3-button w3-white w3-border w3-border w3-round-large commons_button" target="_blank"><img src="img/commons.svg" alt="Wikimedia Commons logo"> Commons</a>
